...
class ScheduleViewController: UIViewController,UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        Passing_Patient_Information.username=results[indexPath.row].patientUsername.replacingOccurrences(of: ".", with: "")
        Passing_Patient_Information.doctor_username=results[indexPath.row].doctorUsername.replacingOccurrences(of: ".", with: "")
        Passing_Patient_Information.time=results[indexPath.row].time
